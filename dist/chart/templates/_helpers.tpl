...
*/}}
{{- define "k8s-glb-operator.fullname" -}}
...
*/}}
{{- define "k8s-glb-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "k8s-glb-operator.resourceName" -}}
{{- $fullname := include "k8s-glb-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "k8s-glb-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "k8s-glb-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
